...
/*      if(Auth::check()){*/
            ...
            if($validator->fails()){
                ...
                $employee->save();
                if(intval($request->get('department')) > 0){
...
/*        if(Auth::check()){*/
            ...
            if($validator->fails()){
                ...
                $employee->save();
                if(intval($request->get('department-edit')) > 0){
...
/*        }*/
    ...
    public function deleteEmployee($id, Request $request){
        ...
        if ( $request->ajax() ) {
            ...
            return response(['msg' => 'Employee deleted', 'id' => $id, 'status' => 'success']);
        }
        return response(['msg' => 'Failed deleting the employee', 'status' => 'failed']);
    }
}
